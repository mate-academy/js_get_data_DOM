1. Replace `<your_account>` with your Github username in the link
    - [DEMO LINK](https://d-hubych.github.io/js_get_data_DOM/)
...
4. Replace `Calculate it!` with calculated average numbers in `span` with classes `average-population` and ``.
5. Calculated `average` and `totatotal-populationl` numbers must be separated by a [thousands separator](https://chortle.ccsu.edu/java5/Notes/chap24B/ch24B_9.html)(same numeric style as populations presented).
