1. Replace `<your_account>` with your Github username in the link
    - [DEMO LINK](https://Mar4enkofff.github.io/js_get_data_DOM/)
...
5. Calculated `average` and `total` numbers must be separated by a [thousands separator][def](same numeric style as populations presented).
6. Congrats, mate! You did it!

![Preview](./src/images/preview.png).


[def]: https://chortle.ccsu.edu/java5/Notes/chap24B/ch24B_9.html
