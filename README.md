1. Replace `<your_account>` with your Github username in the link
    - [DEMO LINK](https://g37ua.github.io/js_get_data_DOM/)
...
3. Рассчитайте среднее и общее значение, основанное на проанализированных числах.
4. Replace `Calculate it!` with calculated average numbers in `span` with classes `average-population` and `total-population`.
5. Calculated `average` and `total` numbers must be separated by a [thousands separator](https://cchortle.ccsu.edu/java5/Notes/chap24B/ch24B_9.html)(same numeric style as populations presented).
