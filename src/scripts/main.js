...
const populationValueTrue = populationValue
  .map(people => +(people.replaceAll(',', '')));

totalPopulationValue.innerText = populationValueTrue
  .reduce((sumOfPopulations, currentPopulation) =>
